...
public class SendLoc_beforeTawklnaOreo extends Service implements
    ...
    public class LocalBinder extends Binder {
        public SendLoc_beforeTawklnaOreo getServerInstance() {
            return SendLoc_beforeTawklnaOreo.this;
        }
    }
    ...
    public void onCreate() {
        ...
        Log.d("onCreat_oreooooo", "oncreat");
        mInProgress = false;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d("onstrat_oreooooo", "oncreat");
...
*/
    ...
    public void onConnectionSuspended(int i) {
        ...
        //appendLog(DateFormat.getDateTimeInstance().format(new Date()) + ": Disconnected", SyncStateContract.Constants.LOG_FILE);
    }
