...
import com.turnpoint.ticram.modules.Report;
import com.turnpoint.ticram.modules.getComplainsTypes;
    ...
    String from_what_act;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            callBackVolly();
             ...
             from_what_act=getIntent().getExtras().getString("from");
            ...
            fields.add(getResources().getString(R.string.choose_type_complaint));
            ids.add("0");
        ...
        public void send_complain(View view){
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ComplaintSupport.this);
            alertDialogBuilder.setMessage(getResources().getString(R.string.are_you_sure));
            alertDialogBuilder.setPositiveButton(getResources().getString(R.string.yes),
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface arg0, int arg1) {
                            if(!selected_field.equals("--اختر نوع التبليغ--") &&
                                    !ed_message.getText().toString().equals("") &&
                                    !selected_field.equals("-- Choose Type --")) {
                                ...
                                Toast.makeText(ComplaintSupport.this, getResources().getString(R.string.enter_required_fields)
            ...
            if(method.equals("get_types")) {
                ...
                if(type_report.equals("support")) {
                    ...
                    voly_ser.getDataVolley(new MySharedPreference(getApplicationContext())
                            .getStringShared("base_url")+PathUrl.ReportComplain_GENERAL);
                }
                else if(type_report.equals("another")) {
                    loading = ProgressDialog.show(ComplaintSupport.this, "",
                            getResources().getString(R.string.please_wait), false, false);
        ...
        void callBackVolly(){
            ...
            iresult= new IResult() {
                ...
                public void notifyError(VolleyError error) {
                    loading.dismiss();
                    Toast.makeText(ComplaintSupport.this,R.string.check_internet, Toast.LENGTH_LONG).show();
