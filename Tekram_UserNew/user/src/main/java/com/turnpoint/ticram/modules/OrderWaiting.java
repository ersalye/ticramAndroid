...
public class OrderWaiting {
    ...
    @Expose
    private String time_to_user ;

    @SerializedName("subtype_img")
    @Expose
    ...
    @SerializedName("time_to_cancel")
    @Expose
    private Integer time_to_cancel;
    ...
    public void setTimetoUser(String time_to_user) {
    ...
    public void setSubtype_img(String subtype_img) {
        this.subtype_img = subtype_img;
    }
    ...
    public Integer getTime_to_cancel() {
        return time_to_cancel;
    }

    public void setTime_to_cancel(Integer time_to_cancel) {
        this.time_to_cancel = time_to_cancel;
    }
