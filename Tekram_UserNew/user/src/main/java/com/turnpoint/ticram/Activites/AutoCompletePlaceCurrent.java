...
public class AutoCompletePlaceCurrent extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_complete_place_current);
        // Initialize Places.
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                try {
                    ...
                    mMap.clear();
                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(selected_lat, selected_lon),
                            16.0f));
                } catch (Exception ex){
                    ex.printStackTrace();
                }
        ...
        mapFragment.getMapAsync(this);
         ...
         public void done_current_loc(View v     ){
             ...
             alertDialogBuilder.setMessage(R.string.dialoge_select_start);
